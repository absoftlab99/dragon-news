                ...
                <Card.Header>
                    <div className='row'>
                        ...
                        <div className="col-6 text-end lh-lg">
                            <span><FaRegBookmark></FaRegBookmark> <FaShareAlt></FaShareAlt></span>
                        </div>
                    </div>
                </Card.Header>
                <Card.Body>
                    ...
                    <div className='text-start pt-2'>
                    {
                        ...
                        <p className='pt-2'>{news.details.slice(0, 400) + '...'} <Link to={`/news/${news._id}`}>Read More</Link></p> :
                        <span className='text-start pt-2'>{news.details}</span>
                    }
                    </div>
                </Card.Body>
